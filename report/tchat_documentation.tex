...
01 & HELLO &  Mensaje \\
\hline
\multirow{2}{*}{02} & \multirow{2}{*}{$<$option$>$} &  Mensaje enviado por el cliente para entrar al servidor,\\
					&							& bien para registrarse o para autenticarse\\
\hline
...
\hline
11 & USRCONNECTED & Mensaje para solicitar la lista de usuarios conectados\\
\hline
